// D3DXFrameWork.cpp : 응용 프로그램에 대한 진입점을 정의합니다.
//
                     ...
                     _In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_D3DXFRAMEWORK, szWindowClass, MAX_LOADSTRING);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_D3DXFRAMEWORK);
